			...
			<Container>
				...
				<Row>
					<Col className="opisLekcije my-3">
						...
						<span class="arapski">(قْ)</span> dođe harf <strong>K</strong> <span class="arapski">(ك)</span>{' '}
						sa <strong>hareketom</strong>:
					</Col>
				</Row>
				...
				<Row>
					<Col className="opisLekcije my-3">
						...
						<span class="arapski">(لْ)</span> dođe harf <strong>R</strong> <span class="arapski">(ر)</span>{' '}
						sa <strong>hareketom</strong>:
					</Col>
				</Row>
