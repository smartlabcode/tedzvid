...
function L21() {
    return (
        ...
        <Row>
          ...
          Kada poslije <strong>dugog vokala</strong> A ـــــَـــــ ا , Iــــــِــــ ى  , U <strong>ـــــُـــــ و</strong> dođe <strong>nestalni sukun</strong>, bit će medd arid. Traje 2-4-6 hareketa.
          </Col>
        </Row>
