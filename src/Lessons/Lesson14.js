			...
			<Container>
				...
				<Row>
					<Col className="opisLekcije text-center">
						...
						{PlayerRow(data, 'row1')}) ili <strong>vokalom</strong> U ( {PlayerRow(data, 'row2')}), npr.:{PlayerRow(data, 'row3')}
					</Col>
				</Row>
				...
				<Row>
					<Col className="opisLekcije">
						...
						harf sa <strong>vokalom</strong> E (<span className="arapski-lekcija" style={{ color: 'red' }}>
							{' '}
							ــَـ رْ{' '}
						</span>) ili U (<span className="arapski-lekcija" style={{ color: 'red' }}>
							ــُـ رْ
						</span>), npr.:
						{PlayerRow(data, 'row4')}
					</Col>
				...
				<Row>
					<Col className="opisLekcije">
						<strong>3.</strong> kada je harf<strong>
							<strong> R </strong>
						</strong>sa <strong>sukunom</strong>, prije njeg harf sa <strong>sukunom</strong>, a prije toga
						harf sa
						<strong>vokalom</strong> E (<span className="arapski-lekcija" style={{ color: 'red' }}>
							...
							{' '}
							ــُـ ــْـ رْ{' '}
						</span>), npr.: {PlayerRow(data, 'row5')}
					</Col>
				</Row>

				<Row>
					<Col className="opisLekcije">
						<strong>4.</strong> kada je harf<strong> R </strong>sa <strong>sukunom</strong> (<span
							className="arapski-lekcija"
							style={{ color: 'red' }}
						>
							رْ
						</span>), a prije njeg glas sa nestalnom kesrom, npr.: {PlayerRow(data, 'row6')}
					</Col>
				</Row>

				<Row>
					<Col className="opisLekcije">
						<strong>5.</strong> kada je harf<strong> R </strong>sa <strong>sukunom</strong> (<span
							className="arapski-lekcija"
							style={{ color: 'red' }}
						>
							رْ
						</span>), a poslije njeg jedan od krupnih harfova, npr.: {PlayerRow(data, 'row7')}
					</Col>
				</Row>
