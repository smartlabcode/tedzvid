			...
			<Container>
				...
				<Row>
					<Col className="opisLekcije">
						...
						<strong>vokal</strong> U<span className="arapski-lekcija">ــــُـــ </span>, riječ Allah
				...
				<Row>
					<Col className="opisLekcije">
						Kada prije riječi Allah<span className="arapski-lekcija"> اللّٰه</span> dođe{' '}
						<strong>vokal</strong> I<span className="arapski-lekcija"> ــــِــ</span>, riječ Allah<span className="arapski-lekcija"> اللّٰه</span>{' '}
