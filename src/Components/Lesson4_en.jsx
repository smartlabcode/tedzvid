			...
			<Container>
				...
				<Row>
					<Col className='opisLekcije'>
						...
						is followed by the <u>same</u> letter with a short <strong>vowel/haraka</strong>, a complete assimilation occurs, i.e. the first letter is not recited,
						and the second one is recited with <strong>shaddah</strong>, for example:
					</Col>
				</Row>
