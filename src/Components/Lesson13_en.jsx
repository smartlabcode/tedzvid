				...
				<Row>
                    ...
                    When one of the five letters {' '} 
						...
						<span className='arapski-lekcija' style={{ fontSize: '1.675em' }}>
							قُطْبُ جَدٍّ)
						</span>{' '}, appears with <strong>sukoon </strong> (<span className='arapski-lekcija'>ـــْـــ</span>)
						, it will be pronounced with an <u>echoing</u> or <u>bouncing</u> sound, for example:
					</Col>
				</Row>
