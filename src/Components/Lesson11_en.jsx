			...
			<Container>
				...
				<Row>
					<Col className='opisLekcije'>
								When the letter N with <strong>sukoon</strong> (ن) or nunation/tanwin EN ـ ـ ـ
								ً ـ ـ ـ IN , ـ ـ ـ UN , ـ ـ ـ is following by one of the 15 letters: <span style={{ display: 'inline-flex' }}>
									<Arabic arabic='ك ت ث ج د ذ ز س ش ص ض ط ظ ف ق' key='arL11'>
										{' '}
										<span style={{color: 'red', fontSize: '2.5rem'}}>ك ت ث ج د ذ ز س ش ص ض ط ظ ف ق</span>{' '}
									</Arabic>
								</span>, then a two-beat <strong>N</strong> (ن) is pronounced through nose, without the tongue touching the palate, for example:
							</Col>
				</Row>
