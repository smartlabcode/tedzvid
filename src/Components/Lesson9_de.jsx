    ...
    <>
      <Row>
        <Col className="opisLekcije">
          Wenn nach dem Buchstaben <strong>nun</strong> mit{" "}
          <strong>sukun</strong>(<span className="arapski-lekcija">نْ</span>)
          oder <strong>tanwin</strong> EN{" "}
          <span className="arapski-lekcija">ـــًـــ</span> , IN{" "}
          <span className="arapski-lekcija">ـــٍــ</span> , UN{" "}
          <span className="arapski-lekcija">ــٌــ</span> einer der IZHAR
          Buchstaben:<pre style={{ display: "inline" }}> </pre>
          ...
          folgt, dann liest man <u>diesen klar</u> und deutlich ohne
      ...
      <Row>
        <Col className="opisLekcije">
          <strong>IZHAR MUTLAK</strong> – Wenn nach dem Buchstaben{" "}
          <strong>nun mit sukun</strong> (
          <span className="arapski-lekcija">نْ</span>) der Buchstabe{" "}
          <strong>V</strong> (<span className="arapski-lekcija">و</span>) oder{" "}
          <strong>J</strong> (<span className="arapski-lekcija">ي</span>) im
          selben Wort vorkommt, dann liest man <strong>nun mit sukun</strong> (
          <span className="arapski-lekcija">ن</span>) <u>deutlich und klar</u>{" "}
          ohne Assimilation. Zum Beispiel:
        </Col>
      </Row>
        ...
        <Row>
          <Col>
            ...
            <h4 className="text-center">
              <strong>
                Deutlich klare Aussprache von nun mit sukun(ن) oder tanwin en,
                in, un
              </strong>
            </h4>
            <hr />
