...
const Lesson17_en = () => {
  ...
  return (
    <>
      <LekcijaMenu broj="17" naziv="AL-MADD AL-TABEE’EE" />
      <Container>
        <Row>
          <Col>
            <div className="mobileTop">
              ...
              <h2
                ...
                id="lekcija"
              >
                17 AL-MADD AL-TABEE’EE
              </h2>
            </div>
            <h4 className="text-center font-weight-bold">Normal extension</h4>
            <hr />
          </Col>
        </Row>
