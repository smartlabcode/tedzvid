    ...
    <>
      <Row>
        <Col className="opisLekcije">
          Wenn nach dem Buchstabe <strong>nun</strong> mit{" "}
          ...
          <span className="arapski-lekcija">ــٌــ</span> einer der zwei idgam
          Buchstaben <strong>L</strong>{" "}
          <span className="arapski-lekcija">(ل) </span>und <strong>R</strong>{" "}
          <span className="arapski-lekcija">(ر)</span>, unmittelbar danach
          folgt, wird <strong>N </strong>
          <span className="arapski-lekcija"> (ن)</span> oder tanwin vollstanding
          in die zvvor genannten Buchstaben <strong>ohne</strong> Nasalisieriung
          assimiliert. Zum Beispiel:
        </Col>
      </Row>
      <Row>
        <Col>
        ...
        <Row>
          <Col>
            ...
            <h4 className="text-center">
              <strong>Vollstandige Assimilation ohne Nasalisierung</strong>
            </h4>
            <hr />
          </Col>
        </Row>
