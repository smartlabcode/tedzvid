      ...
      <Container>
        <Row>
          <Col>
            ...
            <h4 className="text-center">
              <strong>
                Vollständig Assimilation der sich nahe stehenden Buchstaben.
              </strong>
            </h4>
            <hr />
          </Col>
        ...
        <Row>
          <Col className="opisLekcije">
            Wenn nach dem Buchstaben L mit sukun (j) der Buchstabe R (arapski r)
            mit Vokal vorkommt, wird L in R vollständig assimiliert.
          </Col>
        </Row>

        <Row>
          <Col className="opisLekcije ">
            Wenn nach dem Buchstaben <strong>Q</strong> mit{" "}
            <strong>sukoon</strong> <span className="arapski">(قْ)</span> der
            Buchstabe <strong>K</strong> mit vokal{" "}
        ...
        >
          ...
          <Modal.Body className="custom-modal">
            <Row>
              <Col className="opisLekcije">
                Wenn nach dem Buchstaben L mit sukun (j) der Buchstabe R
                (arapski r) mit Vokal vorkommt, wird L in R vollständig
                assimiliert.
              </Col>
            </Row>
