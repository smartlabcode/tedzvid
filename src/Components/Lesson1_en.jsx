      ...
      <Container>
        <Row>
          <Col>
            ...
            <h4 className="text-center" id="lekcija">
              <strong>
                WAQF – stopping during the recitation of the Qur&#39;an
              </strong>
            </h4>
            <hr />
          </Col>
        ...
        <Row>
          <Col className="opisLekcije my-3">
            ...
            <span className="arapski-lekcija"> ـــٌـــ</span> , he will stop as
        ...
        <Row>
          <Col className="opisLekcije my-3">
            ...
            <span className="arapski-lekcija "> ــــًــ</span> , he will stop as
        ...
        <Row>
          <Col className="opisLekcije my-3">
            ...
            <span className="arapski-lekcija">ـــُــ و</span> , he will stop
        ...
        <Row>
          <Col className="opisLekcije my-3">
            ...
            <span className="arapski-lekcija">(ة/ـة)</span> , he will stop as if
            the letter <strong>H </strong>
            <span className="arapski-lekcija">(ه)</span> , were written
        ...
        <Row>
          <Col className="opisLekcije my-3" id="znakovi">
            ...
            <p>
              ...
              <span className="arapski-lekcija"> قصر</span> below the word
              indicates that the vowel under which it is written is <u>short</u>{" "}
              , and <span className="arapski-lekcija"> مد </span>is a sign that
        ...
        >
          ...
          <Modal.Body className="custom-modal">
            <Row>
              <Col className="opisLekcije">
                During the recitation of the Qur&#39;an, the reader can stop in
                the following situations: at the end of the verse, if there is a
                stopping sign and when he is out of breath. It can be done the
                following way:
              </Col>
            </Row>
            <Row>
              <Col className="opisLekcije my-3">
                ...
                <strong>nunation/tanwin</strong> IN{" "}
                <span className="arapski-lekcija "> ــــٍــ </span> , UN{" "}
                <span className="arapski-lekcija"> ـــٌـــ</span> , he will stop
                as if the word ends in <strong>sukoon</strong>{" "}
                <span className="arapski-lekcija "> ــــْـــ</span> , for
                example:
              </Col>
            </Row>
            <Row className="text-center reorder">
            ...
            <Row>
              <Col className="opisLekcije my-3">
                <strong>2.</strong> When the word ends in{" "}
                <strong>tanwin</strong> EN{" "}
                <span className="arapski-lekcija "> ــــًــ</span> , he will
                stop as if it ends in <strong>the long vowel</strong> A{" "}
                <span className="arapski-lekcija "> ـــَـــ ا </span> , for
                example:
              </Col>
            </Row>
            <Row className="text-center reorder">
            ...
            <Row>
              <Col className="opisLekcije my-3">
                <strong>4.</strong> ⦁ When the word ends in round{" "}
                <strong>T</strong>{" "}
                <span className="arapski-lekcija">(ة/ـة)</span> , he will stop
                as if the letter <strong>H </strong>
                <span className="arapski-lekcija">(ه)</span> , were written
                regardless of which vowel or tanwin is written on it, for
                example:
              </Col>
            </Row>
            <Row className="text-center reorder">
