            ...
            <div className="features__grid">
              {ui.features.map((f, i) => (
                <div className="feature" key={f.title}>
                  <span
                    className={
                      "icon-circle icon-circle--" + FEATURE_STYLE[i].tone
                    }
                  >
            ...
            <div className="benefits">
              {ui.benefits.map((b, i) => (
                <div className="benefit" key={b.title}>
                  <span
                    className={
                      "icon-circle icon-circle--sm icon-circle--" +
                      BENEFIT_STYLE[i].tone
                    }
                  >
          ...
          <div className="wrap">
            <div className="contact__card">
              ...
              <form className="contact__form" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="btn-t btn-t--navy span-2 pageclip-form__submit"
                >
