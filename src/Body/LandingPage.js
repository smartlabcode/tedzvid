        ...
        <React.Fragment>
            <div className="wrapper">
                ...
                <div className="topMobileNav">
                    ...
                    <div>
                        <Link to={"/lekcije"}>
                            <svg className="mobNavArrow" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <path id="ic_arrow_back_24px" d="M4,11H16.17L10.58,5.41,12,4l8,8-8,8-1.41-1.41L16.17,13H4Z" transform="translate(-4 -4)" fill="#fce3aa"/>
                            </svg>
                        </Link>
                    </div>
                ...
                <div className="sectionTwo" id="contact">
                        <center>
                            ...
                            <br/>
                            <p>
                                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veritatis molestiae voluptates excepturi eos dignissimos minus quae quasi. Molestias, perspiciatis doloribus ipsum porro commodi, sed pariatur, suscipit recusandae excepturi quasi maiores? Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, qui neque. Pariatur, ratione officia natus eos quod ipsa voluptatibus quam sapiente eligendi, amet cupiditate magni maxime nesciunt vel dolores! Quod!
                            </p>
                            <form className="form" action="" method="post">
                                <input type="text" placeholder="Ime, prezime"/>
                                <input type="email" placeholder="Email" name="" id=""/>
                                <input type="number" placeholder="Broj telefona" name="" id=""/>
                                <input className="textInput" placeholder="Unesi zadržaj porke" type="text" name="" id=""/>
                ...
                <footer className="footerLanding">
                    <div className="contentLeft">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam veniam nulla, est, eos culpa aspernatur adipisci exercitationem incidunt quam velit hic! Optio odio repellendus beatae architecto autem voluptatem blanditiis ipsum!Lorem</p>
                    </div>
                </footer>
            </div>
        </React.Fragment>
